...
def get_region_lut_coordinates(band, region_name):
    ...
    c_band_regions = {
        ...
        c.APR_CREA_BS: ((3671, 3885), (1791, 2023)), # same as JUN_CREA_QU
        c.APR_CREA_DW: ((3284, 3647), (1355, 1641)),
        c.JUN_CREA_SF: ((3339, 3565), (1769, 1930)),
        c.JUN_CREA_QU: ((3671, 3885), (1791, 2023)), # same as APR_CREA_BS
        c.JUN_CREA_MA: ((3338, 3585), (1708, 1895)),
        # CAIONE farn
        c.CAIONE: ((6962, 7654), (2080, 2823)),
        c.APR_CAIONE_DW: ((7110, 7654), (2080, 2765)),
        c.JUN_CAIONE_AA: ((6976, 7225), (2547, 2823)),
        c.JUN_CAIONE_MA: ((6962, 7340), (2149, 2757)),
    }
...
def get_region_radar_coordinates(band, region_name):
    ...
    region_definitions = {
        "L": {
            ...
            c.APR_CREA_BS: ((8783, 9289), (1492, 1811)),
            c.APR_CREA_DW: ((7833, 8706), (1012, 1378)),
            c.JUN_CREA_SF: ((7984, 8525), (1466, 1703)),
            c.JUN_CREA_QU: ((8783, 9289), (1492, 1811)),
            c.JUN_CREA_MA: ((7979, 8570), (1396, 1662)),
            c.CAIONE: ((16661, 18336), (1850, 2820)),
            c.APR_CAIONE_DW: ((17013, 18336), (1850, 2746)),
            c.JUN_CAIONE_AA: ((16717, 17316), (2428, 2820)),
            c.JUN_CAIONE_MA: ((16661, 17589), (1932, 2736)),
        },
        "C": {
            c.CREA: ((15414, 18315), (2021, 3619)),
            c.APR_CREA_BS: ((17303, 18315), (2980, 3619)),
            c.APR_CREA_DW: ((15414, 17156), (2021, 2752)),
            c.JUN_CREA_SF: ((15707, 16788), (2928, 3402)),
            c.JUN_CREA_QU: ((17303, 18315), (2980, 3619)),
            c.JUN_CREA_MA: ((15699, 16879), (2790, 3321)),
            c.CAIONE: ((33045, 36386), (3697, 5638)),
            c.APR_CAIONE_DW: ((33750, 36386), (3697, 5490)),
            c.JUN_CAIONE_AA: ((33149, 34345), (4853, 5638)),
            c.JUN_CAIONE_MA: ((33045, 34891), (3860, 5468)),
        },
    }
...
def get_soil_texture_by_region(region_name):
    ...
    if region_name in [c.CREA, c.APR_CREA_BS, c.APR_CREA_DW, c.JUN_CREA_SF, c.JUN_CREA_QU, c.JUN_CREA_MA]:
        crea_sand, crea_clay = 26.8, 32.4
        return crea_sand, crea_clay
    if region_name in [c.CAIONE, c.APR_CAIONE_DW, c.JUN_CAIONE_AA, c.JUN_CAIONE_MA]:

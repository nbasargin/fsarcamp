...
class CROPEX14Biomass:
    ...
    def _get_additional_data(self):
        ...
        rows = [
            ...
            (datetime.datetime(2014, 4, 9, 10, 10), "W10_Triangular", np.nan, np.nan, 20, np.nan, "Wallerfing_soil_moisture_2014_04_09.xlsx"),
            (datetime.datetime(2014, 4, 9, 8, 55), "C1_Meteo", np.nan, np.nan, 0, np.nan, "Wallerfing_soil_moisture_2014_04_09.xlsx"), # bare soil
            (datetime.datetime(2014, 4, 9, 10, 10), "C2_Big", np.nan, np.nan, 0, np.nan, "Wallerfing_soil_moisture_2014_04_09.xlsx"), # bare soil
            # Wallerfing_soil_moisture_2014_04_10
            (datetime.datetime(2014, 4, 10, 8, 40), "C1_Meteo", np.nan, np.nan, 0, np.nan, "Wallerfing_soil_moisture_2014_04_10.xlsx"), # bare soil
            (datetime.datetime(2014, 4, 10, 9, 10), "C2_Big", np.nan, np.nan, 0, np.nan, "Wallerfing_soil_moisture_2014_04_10.xlsx"), # bare soil
            # Wallerfing_soil_moisture_2014_04_11            
            (datetime.datetime(2014, 4, 11, 11, 0), "W10_Triangular", np.nan, np.nan, 20, np.nan, "Wallerfing_soil_moisture_2014_04_11.xlsx"),
            (datetime.datetime(2014, 4, 11, 8, 25), "C1_Meteo", np.nan, np.nan, 0, np.nan, "Wallerfing_soil_moisture_2014_04_11.xlsx"), # bare soil
            (datetime.datetime(2014, 4, 11, 8, 55), "C2_Big", np.nan, np.nan, 0, np.nan, "Wallerfing_soil_moisture_2014_04_11.xlsx"), # bare soil
            # Wallerfing_soil_moisture_2014_05_15
            (datetime.datetime(2014, 5, 15, 11, 45), "W10_Triangular", np.nan, np.nan, 50, np.nan, "Wallerfing_soil_moisture_2014_05_15.xlsx"),
            (datetime.datetime(2014, 5, 15, 10, 0), "C1_Meteo", np.nan, np.nan, 5, np.nan, "Wallerfing_soil_moisture_2014_05_15.xlsx"), # maize 5 cm
            (datetime.datetime(2014, 5, 15, 9, 30), "C2_Big", np.nan, np.nan, 10, np.nan, "Wallerfing_soil_moisture_2014_05_15.xlsx"), # maize 10 cm
            # Wallerfing_soil_moisture_2014_05_22
            #   wheat: height 50-60 cm, bbch 30 (begin of stem elongation)
            (datetime.datetime(2014, 5, 22, 8, 45), "W10_Triangular", np.nan, np.nan, 55, 30, "Wallerfing_soil_moisture_2014_05_22.xlsx"),
            #   maize C2: height 15 cm, bbch 13 (3-4 leaves)
            (datetime.datetime(2014, 5, 22, 9, 45), "C1_Meteo", np.nan, np.nan, 15, 13, "Wallerfing_soil_moisture_2014_05_22.xlsx"),
            #   maize C2: height 10 cm, bbch 13 (3-4 leaves)
            (datetime.datetime(2014, 5, 22, 10, 30), "C2_Big", np.nan, np.nan, 10, 13, "Wallerfing_soil_moisture_2014_05_22.xlsx"),
            # Wallerfing_soil_moisture_2014_06_04
            (datetime.datetime(2014, 6, 4, 9, 0), "W10_Triangular", np.nan, np.nan, 69, np.nan, "Wallerfing_soil_moisture_2014_06_04.xlsx"),
            #   maize C1: height 40 cm, height 29 cm near meteo station, bbch 16 (6 leaves)
            (datetime.datetime(2014, 6, 4, 10, 15), "C1_Meteo", np.nan, np.nan, 40, 16, "Wallerfing_soil_moisture_2014_06_04.xlsx"),
            (datetime.datetime(2014, 6, 4, 10, 15), "C1_Meteo_near_station", np.nan, np.nan, 29, 16, "Wallerfing_soil_moisture_2014_06_04.xlsx"),
            (datetime.datetime(2014, 6, 4, 11, 20), "C2_Big", np.nan, np.nan, 28, 16, "Wallerfing_soil_moisture_2014_06_04.xlsx"),
            # Wallerfing_soil_moisture_2014_06_12
            #   maize C1: height 85-95 cm, height 50-60 cm near meteo station
            (datetime.datetime(2014, 6, 12, 9, 20), "C1_Meteo", np.nan, np.nan, 90, np.nan, "Wallerfing_soil_moisture_2014_06_12.xlsx"),
            (datetime.datetime(2014, 6, 12, 9, 20), "C1_Meteo_near_station", np.nan, np.nan, 55, np.nan, "Wallerfing_soil_moisture_2014_06_12.xlsx"),
            (datetime.datetime(2014, 6, 12, 10, 40), "C2_Big", np.nan, np.nan, 63, np.nan, "Wallerfing_soil_moisture_2014_06_12.xlsx"),
            # Wallerfing_soil_moisture_2014_06_18
            #   maize C1: height 118-125 cm, height 90 cm near meteo station
            (datetime.datetime(2014, 6, 18, 9, 10), "C1_Meteo", np.nan, np.nan, 121.5, np.nan, "Wallerfing_soil_moisture_2014_06_18.xlsx"),
            (datetime.datetime(2014, 6, 18, 9, 10), "C1_Meteo_near_station", np.nan, np.nan, 90, np.nan, "Wallerfing_soil_moisture_2014_06_18.xlsx"),
            #   maize C2: height 90-105 cm
            (datetime.datetime(2014, 6, 18, 10, 0), "C2_Big", np.nan, np.nan, 97.5, np.nan, "Wallerfing_soil_moisture_2014_06_18.xlsx"),
            #   Big field, cucumber: 27-31 cm, sugar beet 36 cm
            # Wallerfing_soil_moisture_2014_06_27
            #   wheat: height 75-80 cm
            (datetime.datetime(2014, 6, 27, 17, 15), "W10_Triangular", np.nan, np.nan, 77.5, np.nan, "Wallerfing_soil_moisture_2014_06_27.xlsx"),
            #   maize C1: point #1: 155-160 cm, point #3: 120-125 cm, point #9: 130-135 cm
            (datetime.datetime(2014, 6, 27, 16, 30), "C1_Meteo_point_1", 12.87521, 48.69478, 157.5, np.nan, "Wallerfing_soil_moisture_2014_06_27.xlsx"),
            (datetime.datetime(2014, 6, 27, 16, 30), "C1_Meteo_point_3", 12.87415, 48.69449, 122.5, np.nan, "Wallerfing_soil_moisture_2014_06_27.xlsx"),
            (datetime.datetime(2014, 6, 27, 16, 30), "C1_Meteo_point_9", 12.87502, 48.69415, 132.5, np.nan, "Wallerfing_soil_moisture_2014_06_27.xlsx"),
            #   maize C2: height 120-125 cm
            (datetime.datetime(2014, 6, 27, 16, 20), "C2_Big", np.nan, np.nan, 122.5, np.nan, "Wallerfing_soil_moisture_2014_06_27.xlsx"),
            ...
            (datetime.datetime(2014, 7, 3, 14, 30), "W10_Triangular_point_3", 12.85405, 48.69044, 77.5, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 14, 30), "W10_Triangular_point_12", 12.85452, 48.68953, 87.5, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            #   maize C1: point #1: 210-215 cm, point #2: 185-195 cm, point #4: 145-150 cm, point # 8: 170-175 cm, point #10: 175-185 cm
            (datetime.datetime(2014, 7, 3, 8, 45), "C1_Meteo_point_1", 12.87523, 48.69476, 212.5, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 8, 45), "C1_Meteo_point_2", 12.87476, 48.69460, 190, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 8, 45), "C1_Meteo_point_4", 12.87382, 48.69438, 147.5, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 8, 45), "C1_Meteo_point_8", 12.87452, 48.69402, 172.5, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 8, 45), "C1_Meteo_point_10", 12.87549, 48.69429, 180, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            #   maize C2: point #2: 120-125 cm, point #5: 180-190 cm, point #12: 125-135 cm 
            (datetime.datetime(2014, 7, 3, 10, 20), "C2_Big_point_2", 12.87456, 48.69619, 122.5, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 10, 20), "C2_Big_point_5", 12.87308, 48.69587, 185, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            (datetime.datetime(2014, 7, 3, 10, 20), "C2_Big_point_12", 12.87267, 48.69652, 130, np.nan, "Wallerfing_soil_moisture_2014_07_03.xlsx"),
            ...
            (datetime.datetime(2014, 7, 18, 10, 30), "W10_Triangular", np.nan, np.nan, 75, 62, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            #   maize C1: height point #1: 320-340 cm, point #4: 280 cm, point #6 280 cm, point #8: 290-300 cm, point #10: 280cm
            (datetime.datetime(2014, 7, 18, 9, 0), "C1_Meteo_point_1", 12.87525, 48.69473, 330, np.nan, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            (datetime.datetime(2014, 7, 18, 9, 0), "C1_Meteo_point_4", 12.87368, 48.69439, 280, np.nan, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            (datetime.datetime(2014, 7, 18, 9, 0), "C1_Meteo_point_6", 12.87351, 48.69381, 280, np.nan, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            (datetime.datetime(2014, 7, 18, 9, 0), "C1_Meteo_point_8", 12.87453, 48.69403, 295, np.nan, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            (datetime.datetime(2014, 7, 18, 9, 0), "C1_Meteo_point_10", 12.87552, 48.69429, 280, np.nan, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            #   maize C2: height point #1: 260-270 cm, corn is in flowering stage
            (datetime.datetime(2014, 7, 18, 8, 45), "C2_Big_point_1", 12.87493, 48.69627, 265, np.nan, "Wallerfing_soil_moisture_2014_07_18.xlsx"),
            ...
            (datetime.datetime(2014, 7, 24, 0, 0), "C1_Meteo_point_3", 12.87509, 48.69416, 288, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            (datetime.datetime(2014, 7, 24, 0, 0), "C1_Meteo_point_4", 12.87471, 48.69458, 320, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            (datetime.datetime(2014, 7, 24, 0, 0), "C1_Meteo_point_6", 12.87459, 48.69404, 320, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            (datetime.datetime(2014, 7, 24, 0, 0), "C1_Meteo_point_10", 12.87349, 48.69385, 300, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            #   maize C2: height point #1: 280 cm, point #6: 337 cm, point #15: 312 cm, point #47: 317 cm
            (datetime.datetime(2014, 7, 24, 9, 0), "C2_Big_point_1", 12.87494, 48.69625, 280, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            (datetime.datetime(2014, 7, 24, 9, 0), "C2_Big_point_6", 12.87247, 48.69576, 337, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            (datetime.datetime(2014, 7, 24, 9, 0), "C2_Big_point_15", 12.87211, 48.69645, 312, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            (datetime.datetime(2014, 7, 24, 9, 0), "C2_Big_point_47", 12.87171, 48.69511, 317, np.nan, "Wallerfing_soil_moisture_2014_07_24.xlsx"),
            # Wallerfing_soil_moisture_2014_08_04
            #   maize C1: height 290 cm, another measurement 330-340 cm
            (datetime.datetime(2014, 8, 4, 11, 30), "C1_Meteo_a", np.nan, np.nan, 290, np.nan, "Wallerfing_soil_moisture_2014_08_04.xlsx"),
            (datetime.datetime(2014, 8, 4, 11, 30), "C1_Meteo_b", np.nan, np.nan, 335, np.nan, "Wallerfing_soil_moisture_2014_08_04.xlsx"),
            #   maize C2: height point #6: 320 cm
            (datetime.datetime(2014, 8, 4, 12, 37), "C2_Big_point_6", 12.87200, 48.69564, 320, np.nan, "Wallerfing_soil_moisture_2014_08_04.xlsx"),
            ...
            (datetime.datetime(2014, 8, 21, 12, 20), "C1_Meteo_point_1", 12.87527, 48.69476, 338, np.nan, "Wallerfing_soil_moisture_2014_08_21.xlsx"),
            (datetime.datetime(2014, 8, 21, 12, 20), "C1_Meteo_point_7", 12.87406, 48.69393, 302, np.nan, "Wallerfing_soil_moisture_2014_08_21.xlsx"),
            #   maize C2: height point #1: 275-293 cm, point #7: 342 cm, point #14: 334 cm
            (datetime.datetime(2014, 8, 21, 9, 40), "C2_Big_point_1", 12.87499, 48.69625, 284, np.nan, "Wallerfing_soil_moisture_2014_08_21.xlsx"),
            (datetime.datetime(2014, 8, 21, 9, 40), "C2_Big_point_7", 12.87200, 48.69569, 342, np.nan, "Wallerfing_soil_moisture_2014_08_21.xlsx"),
            (datetime.datetime(2014, 8, 21, 9, 40), "C2_Big_point_14", 12.87162, 48.69632, 334, np.nan, "Wallerfing_soil_moisture_2014_08_21.xlsx"),
            #   Big field, cucumber: as last time, sugar beet: 50-55 cm
            # Wallerfing_soil_moisture_2014_08_24
            #   maize C1: height point #2: 325 cm
            (datetime.datetime(2014, 8, 24, 9, 15), "C1_Meteo_point_2", 12.87475, 48.69457, 325, np.nan, "Wallerfing_soil_moisture_2014_08_24.xlsx"),
            #   maize C2: height point #2: 315-320 cm, row spacing 18x76 (?)
            (datetime.datetime(2014, 8, 24, 10, 30), "C2_Big_point_2", 12.87406, 48.69605, 317.5, np.nan, "Wallerfing_soil_moisture_2014_08_24.xlsx"),

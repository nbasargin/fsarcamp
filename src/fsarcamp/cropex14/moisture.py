...
class CROPEX14Moisture:
    ...
    def load_soil_moisture_points(self, date_name: str | None = None):
        """
        Load point soil moisture ground measurements.
        If a date is provided, only load excel files for that date are loaded.
        Otherwise, all ground measuremetns from all excel files are loaded.
        A date is defined by a string (see fsarcamp.cropex14.dates).
        ...
        # 2014_04_09
        if date_name is None or date_name == cr14.APR_09:
        ...
        # 2014_04_10
        if date_name is None or date_name == cr14.APR_10:
        ...
        # 2014_04_11
        if date_name is None or date_name == cr14.APR_11:
        ...
        # 2014_05_15
        if date_name is None or date_name == cr14.MAY_15:
        ...
        # 2014_05_22
        if date_name is None or date_name == cr14.MAY_22:
        ...
        # 2014_06_04
        if date_name is None or date_name == cr14.JUN_04:
        ...
        # 2014_06_12
        if date_name is None or date_name == cr14.JUN_12:
        ...
        # 2014_06_18
        if date_name is None or date_name == cr14.JUN_18:
        ...
        # 2014_06_27 (part 1)
        if date_name is None or date_name == cr14.JUN_27:
        ...
        # 2014_07_03
        if date_name is None or date_name == cr14.JUL_03:
        ...
        # 2014_07_18
        if date_name is None or date_name == cr14.JUL_18:
        ...
        # 2014_07_24
        if date_name is None or date_name == cr14.JUL_24:
        ...
        # 2014_07_30
        if date_name is None or date_name == cr14.JUL_30:
        ...
        # 2014_08_04
        if date_name is None or date_name == cr14.AUG_04:
        ...
        # 2014_08_21
        if date_name is None or date_name == cr14.AUG_21:
            ...
            # 2014_08_24
        if date_name is None or date_name == cr14.AUG_24:
    ...
    def geocode_dataframe(self, df, band, pass_name):
        """
        Extend a dataframe with easting-northing and azimuth-range coordinates (for a specific F-SAR pass).
        The dataframe must have "latitude" and "longitude" columns defined.
        Additionals columns are added to the dataframe:

...
class CROPEX14Moisture:
    def __init__(self, data_folder):
        """
        The data_folder contains the XLSX files with soil moisture measurements for the CROPEX14 campaign.
        Default location on DLR servers as of April 2024:
            fsarcamp.get_polinsar_folder() / "Ground_truth/Wallerfing_campaign_May_August_2014/Data/ground_measurements/soil_moisture"
        """
    ...
    def _read_soil_moisture_sheet(self, file_path, sheet_name, num_rows, field_name, point_id_offset=0):
        ...
        """
        latlong_to_lut = self._get_lat_long_to_lut_transformer()
    ...
    def read_cropex14_soil_moisture(self):
        ...
        if triangular_2014_06_27.at[2, "longitude"] == 12.85467:
            ...
            easting, northing = self._get_lat_long_to_lut_transformer().transform(correct_long, lat)
